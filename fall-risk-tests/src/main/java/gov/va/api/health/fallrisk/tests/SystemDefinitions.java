...
public class SystemDefinitions {
  ...
  private static SystemDefinition lab() {
    ...
    return SystemDefinition.builder()
        .fallRisk(serviceDefinition("fall-risk", url, 443, "/services/fallrisk"))
        .build();
  }
  ...
  private static SystemDefinition local() {
    ...
    return SystemDefinition.builder()
        .fallRisk(serviceDefinition("fall-risk", url, 8070, "/fallrisk"))
        .build();
  }
  ...
  private static SystemDefinition qa() {
    ...
    return SystemDefinition.builder()
        .fallRisk(serviceDefinition("fall-risk", url, 443, "/fallrisk"))
        .build();
  }
