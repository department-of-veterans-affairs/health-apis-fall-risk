...
public class FallRiskIT {
  ...
  public void searchByFacilityAndSince() {
    ...
    log.info(
        "Verify {}v0/assessment?facility={}&since={} is list of FallRiskAssessmentResponse (200)",
        apiPath(),
        facility,
        lastUpdated);
  ...
  public void searchByFacilityAndSinceReturnsBadRequestForUnparseableDate() {
    log.info("Verify {}v0/assessment?facility=640&since=IDKMYBFFJILL is status (400)", apiPath());
    ExpectedResponse.of(
            TestClients.fallRisk()
                .service()
                .requestSpecification()
                ...
                .request(
                    Method.GET,
                    TestClients.fallRisk().service().urlWithApiPath()
                        + "v0/assessment?facility=640&since=IDKMYBFFJILL"))
        .expect(400);
  }
  ...
  public void searchByPatient() {
    ...
    log.info(
        "Verify {}v0/assessment?patient={} is list of FallRiskAssessmentResponse (200)",
        apiPath(),
        patientFullIcn);
    List<FallRiskAssessmentResponse> response =
        ExpectedResponse.of(
  ...
  @Test
  @Category({Local.class, LabFallRisk.class, ProdFallRisk.class})
  public void unversionedSearchByFacilityAndSince() {
    final String facility = systemDefinition().testIds().station();
    final String lastUpdated = systemDefinition().testIds().since();
    log.info(
  ...
  @Test
  @Category({Local.class, LabFallRisk.class, ProdFallRisk.class})
  public void unversionedSearchByFacilityAndSinceReturnsBadRequestForUnparseableDate() {
  ...
  @Test
  @Category({Local.class, LabFallRisk.class, ProdFallRisk.class})
  public void unversionedSearchByPatient() {
    final String patientFullIcn = systemDefinition().testIds().patient();
    log.info(
